        ...
        <div className='flex'>
          {
            !showProfile ?
              <div className="md:flex md:flex-col min-w-[360px] h-[100vh] md:h-[98.6vh] bg-[#ffff] relative">
                ...
                <div className='h-[61px] px-4' style={{background:"#26263b"}}>
                  <div className='flex'>
                    <a className='flex items-center relative  -top-4 block h-[90px]' href='/'>

                      <h3 className='text-[20px] text-[#1f2228] font-body font-extrabold tracking-wider' style={{color:"white"}}>Messages</h3>
                    </a>
                  </div>
                ...
                <div>
                  ...
                  <div className='relative pt-6 px-4' style={{backgroundColor:"#1d1d29"}}>
                    <form onSubmit={(e) => e.preventDefault()}>

                      <input style={{background:"#54556e"}} onChange={handleSearch} className='w-[99.5%] bg-[#f6f6f6] text-[#111b21] tracking-wider pl-9 py-[8px] rounded-[9px] outline-0' type="text" name="search" placeholder="Search" />
          ...
          <Chat className="chat-page relative lg:w-[100%] h-[100vh] bg-[rgb(64, 65, 95)]" />
